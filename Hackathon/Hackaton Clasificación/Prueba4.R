...
mlp.fit = train(form = Y ~ X3 + X6 + X9 + X10 + (X10)^2 + (X10)^3, #formula for specifying inputs and outputs.
...
write.table(Solucion3 ,"T25_4.csv", col.names = FALSE, row.names = FALSE)
